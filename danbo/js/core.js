...
var I18N={
    ...
    version:(function(){var v=String(window.DANBO_ASSET_VERSION||'v=20260907.10').replace(/^v=/,'v');return{zhs:v+' by \u767D\u6CB3\u6101',zht:v+' by \u767D\u6CB3\u6101',ja:v+' by \u767D\u6CB3\u6101',en:v+' by Kryso'};})(),
...
function disposeTransientObject3D(root,disposeTextures){
    ...
    var visit=function(object){
        ...
        for(var i=0;i<list.length;i++){
            var material=list[i];if(!material||!material.dispose)continue;
