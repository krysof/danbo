...
class GTAOPass extends Pass {
	...
	_overrideVisibility() {
		...
		scene.traverse( function ( object ) {
			...
			// DANBO: additive sprites, particles and other purely emissive effects
			// must not become solid occluders in the override normal/depth pass.
			let noAO = object.userData && object.userData.noAO === true;
			let parent = object.parent;
			while ( ! noAO && parent ) {

				noAO = parent.userData && parent.userData.noAO === true;
